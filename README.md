...
![The MacLaine Finance decision flowchart](assets/flowchart.png)
...
| | |
|---|---|
| [![FIRE projection with Swedish pensions modelled in, plus a return-vs-savings sensitivity matrix](assets/fire.png)](https://maclaine.se/en/finance/fire) | [![Where do I stand? Your income ranked against real Swedish distribution data](assets/benchmark.png)](https://maclaine.se/en/finance/benchmark) |
...
| [![Where does the money go? From employer cost to net take-home in one flow](assets/salary-sankey.png)](https://maclaine.se/en/finance/salary) | [![Type your details once. Every tool reads the same shared profile, stored only in your browser](assets/drawer.png)](https://maclaine.se/en/finance) |
